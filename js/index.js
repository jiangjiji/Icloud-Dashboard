Array.from(document.getElementsByClassName("hover")).forEach(function (
  element
) {
  element.addEventListener("click", function (e) {
    if (e.currentTarget.id === "iCloud") {
      window.open(`https://www.icloud.com.cn`);
    } else {
      window.open(`https://www.icloud.com.cn/${e.currentTarget.id}`);
    }
  });
});
